...
{
    public class Node_Mirror : Node, IXNodeConvertable, ISerializableNode
    {

        public override void Init(Vector2 position)
        {
            Init(position, new Node_MirrorWindow(), title: "Mirror");
    ...
    public class Node_MirrorWindow : NodeModule
    {
        ...
        public override void OnGUI()
        {
            ...
            Node_Mirror n = (Node_Mirror)node;
