...
{
    public class Node_AppendFeatures : Node, IXNodeConvertable, ISerializableNode
    {

        public override void Init(Vector2 position)
        {
            Init(position, new Node_AppendFeaturesWindow(), title: "AppendFeatures");

            AddInput(typeof(LayoutGraphConnection), "Input");
            AddInput(typeof(LayoutGraphConnection), "AppendFrom");
            AddOutput(typeof(LayoutGraphConnection), "Output");
        }

        public void LoadValuesFromXNode(XNode.Node node)
        {
            if (node is AppendFeatures roomGrid)
            {
    ...
    public class Node_AppendFeaturesWindow : NodeModule
    {
        ...
        public override void OnGUI()
        {
            ...
            Node_AppendFeatures n = (Node_AppendFeatures)node;
            ...
            CreateOptionalInput(n.inputs[1]);
        }
    }
}