...
{
    public class Node_RequireNoOverlaps : Node, IXNodeConvertable, ISerializableNode
    {

        public override void Init(Vector2 position)
        {
            Init(position, new Node_RequireNoOverlapsWindow(), title: "RequireNoOverlaps");
        ...
        {
            if (node is RequireNoOverlaps roomGrid)
            {
    ...
    public class Node_RequireNoOverlapsWindow : NodeModule
    {
        ...
        public override void OnGUI()
        {
            ...
            Node_RequireNoOverlaps n = (Node_RequireNoOverlaps)node;
