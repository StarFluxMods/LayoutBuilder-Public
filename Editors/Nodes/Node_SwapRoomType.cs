...
{
    public class Node_SwapRoomType : Node, IXNodeConvertable, ISerializableNode
    {

        public override void Init(Vector2 position)
        {
            Init(position, new Node_SwapRoomTypeWindow(), title: "SwapRoomType");
        ...
        {
            if (node is SwapRoomType roomGrid)
            {
    ...
    public class Node_SwapRoomTypeWindow : NodeModule
    {
        ...
        public override void OnGUI()
        {
            ...
            Node_SwapRoomType n = (Node_SwapRoomType)node;
